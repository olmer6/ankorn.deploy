                ...
                <article role="article" class="node node--type-page node--promoted node--view-mode-full">
                    ...
                    <div class="node__content">
                        ...
                        <div class="clearfix text-formatted field field--name-body field--type-text-with-summary field--label-hidden field__item">
                            <p>Вы можете обратиться к&nbsp;нам любым удобным способом: позвонить по&nbsp;телефону, заказать обратный звонок, воспользоваться электронной почтой или прийти в&nbsp;офис.</p>
