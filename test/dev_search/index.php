...
?>
    ...
    <div class="container">
        ...
        <div class="search-tabs" id="searchTabs">
            <button type="button" class="search-tabs__btn active" data-tab="1">Умный поиск по каталогу</button>
            <button type="button" class="search-tabs__btn" data-tab="2">Умная страница поиска</button>
        </div>
