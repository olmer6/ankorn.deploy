...
include($_SERVER["DOCUMENT_ROOT"]."/test/logArray.php");
include($_SERVER["DOCUMENT_ROOT"]."/test/class.php");
include($_SERVER["DOCUMENT_ROOT"]."/test/dataArrays.php");

$ibid = 2; // инфоблок продукты
$arSelect = array();
$arSelect= ['IBLOCK_ID','ID','NAME','PREVIEW_TEXT',"DETAIL_TEXT",'PROPERTY_*'];
$arSelectPropertyId = array();


$properties = \OLM\AnkornCatalogPropApdater::GetIBlockProperties();
