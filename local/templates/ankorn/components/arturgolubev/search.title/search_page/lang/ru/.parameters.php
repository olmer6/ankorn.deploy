...
$MESS["TP_BST_SHOW_PROPS"] = "Выводить свойства элементов (укажите ID или Символьные коды)";
...
$MESS["TP_BST_SHOW_HISTORY_POPUP"] = "Отображать историю запросов в выпадающем списке";

$MESS["TP_BST_SHOW_QUANTITY"] = "Показывать доступное количество";
$MESS["TP_BST_VOICE_INPUT"] = "Голосовой ввод";

$MESS["TP_BST_QUICK_VARIANTS_SHOW"] = "Показать блок Часто ищут";
$MESS["TP_BST_QUICK_VARIANTS_VALUE"] = "Значения блока Часто ищут";
?>