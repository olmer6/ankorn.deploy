...
$arTemplateParameters["QUICK_VARIANTS_SHOW"] = [
	"NAME" => Loc::getMessage("TP_BST_QUICK_VARIANTS_SHOW"),
	"TYPE" => "CHECKBOX",
	"DEFAULT" => "N",
	"PARENT" => "TEMPLATE_PARAMS",
	'REFRESH' => 'Y',
...
if (isset($arCurrentValues['QUICK_VARIANTS_SHOW']) && 'Y' == $arCurrentValues['QUICK_VARIANTS_SHOW'])
{
	$arTemplateParameters["QUICK_VARIANTS_VALUE"] = [
		"NAME" => Loc::getMessage("TP_BST_QUICK_VARIANTS_VALUE"),
		"TYPE" => "STRING",
		"DEFAULT" => "",
		"PARENT" => "TEMPLATE_PARAMS",
		"MULTIPLE" => "Y",
