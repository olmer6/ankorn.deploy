...
<div class="<? echo $arCurView['CONT']; ?>"><?
    ...
    if (0 < $arResult["SECTIONS_COUNT"]) {
        ...
        <div class="applications__list">
            <div class="applications__item applications-title">
                <h2>Примеры использования нашего оборудования</h2>
            </div>
            <?
            ...
            case 'LINE':
                foreach ($arResult['SECTIONS'] as &$arSection) {
                    ...
                    ?>
                <div id="<? echo $this->GetEditAreaId($arSection['ID']); ?>" class="applications__item">
                    <div
                            href="<? echo $arSection['SECTION_PAGE_URL']; ?>"
                            class="applications__item-img"
