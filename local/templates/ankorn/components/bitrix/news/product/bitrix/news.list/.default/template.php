    ...
    <? foreach ($arResult["ITEMS"] as $arItem): ?>
        ...
        <div class="catalog-col catalog-col--4">
            <article class="commerce-product catalog-preview catalog-preview--product">
                ...
                <?php if (is_array($arItem['PROPERTIES']['SHORT_DESC_PRODUCT_LIST']["VALUE"]) && isset($arItem['PROPERTIES']['SHORT_DESC_PRODUCT_LIST']["VALUE"]['TEXT'])): ?>
                <div class="catalog-preview-text text-formatted">
                    <?= htmlspecialcharsBack($arItem['PROPERTIES']['SHORT_DESC_PRODUCT_LIST']["VALUE"]['TEXT']) ?>
                </div>
                <?php endif; ?>

                <?php if (is_array($arItem['PROPERTIES']['FULL_DESC_PRODUCT_LIST']["VALUE"]) && isset($arItem['PROPERTIES']['FULL_DESC_PRODUCT_LIST']["VALUE"]['TEXT'])): ?>
