...
<?php if(!$_SESSION[$arParams["COMPARE_NAME"]][$arParams["IBLOCK_ID"]]["ITEMS"]){
    ...
    <div class="page-container">
        <div class="favorites-page">
            <h1 id="catalog-h1">Сравниваемые товары</h1>
            <div style="display: block;">
                <p>Пока нет товаров для сравнения</p>
...
<?php
    ...
    <?php $APPLICATION->IncludeComponent("bitrix:catalog.compare.result", "ankorn_v2" ,array(
