...
?>
<div class="page-container page-container-compare">
	<h1 id="catalog-h1">Сравнение</h1>
	<div class="row mb-4">

<div class="br-grey col-lg-3 col-md-4 col-sm-5">
...
<div class="catalog-compare pb-4 col-lg-9 col-md-8 col-sm-7 bx-<? echo $templateData['TEMPLATE_CLASS']; ?>" id="bx_catalog_compare_block"><?
	if ($isAjax)
	{
