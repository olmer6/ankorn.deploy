...
<div class="page-container page-container-confirm">
	<div class="row mb-5">
		<div class="col">
	...
	<? if ($arParams['NO_PERSONAL'] !== 'Y'): ?>
		<div class="row mb-5">
			<div class="col">
				<!-- <?=Loc::getMessage('SOA_ORDER_SUC1', ['#LINK#' => $arParams['PATH_TO_PERSONAL']])?> Данные для доступа к сайту были высланы на указанную вами почту -->
				<p>Спасибо, ваш заказ принят в работу!</p>
				<p>Мы свяжемся с вами максимально оперативно для уточнения деталей. </p>
				<p>КП и счёт на оплату направим в день обращения.</p>
			</div>
		</div>
	<? endif; ?>
