...
//            if((empty($arParams["REQUIRED_FIELDS"]) || in_array("FIO", $arParams["REQUIRED_FIELDS"])) && strlen($_POST["user_fio"]) <= 1)
//                $arResult["ERROR_MESSAGE"][] = GetMessage("MF_REQ_FIO");
...
//            if((empty($arParams["REQUIRED_FIELDS"]) || in_array("CITY", $arParams["REQUIRED_FIELDS"])) && empty($_POST["user_city"]))
...
//            $_SESSION["MF_PHONE"] = htmlspecialcharsbx($_POST["user_phone"]);
        ...
        $arResult["PRODUCT_NAME"] = htmlspecialcharsbx($_POST["product_name"]);
        $arResult["AUTHOR_COMPANY"] = htmlspecialcharsbx($_POST["user_company"]);
    }
    else
