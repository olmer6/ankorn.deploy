...
$APPLICATION->SetPageProperty("description", "Датчики проводимости воды - купить у официального представителя с доставкой по всем регионам России. Подробное описание продукции, характеристики, цены от производителя. Гарантия качества");
$APPLICATION->SetPageProperty("keywords", "купить датчик проводимости воды, выбор датчика проводимости воды, цены на датчики проводимости воды");
$APPLICATION->SetPageProperty("title", "Датчики проводимости воды - каталог, цены | Компания Анкорн");
$APPLICATION->SetTitle("Датчики проводимости воды");
...
<div class="container">
	<div class="page-title">
		<h1>Датчики проводимости воды</h1>
	</div>
	<div class="page-desc">
