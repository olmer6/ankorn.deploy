...
$APPLICATION->SetPageProperty("keywords", "купить реле давления, выбор реле давления,цена реле перепада давления, подбор реле перепада давления, датчик реле давления");
$APPLICATION->SetPageProperty("description", "Реле давления - купить у официального представителя с доставкой по всем регионам России. Подробное описание продукции, характеристики, цены от производителя. Гарантия качества");
$APPLICATION->SetPageProperty("title", "Реле давления - каталог, цены | Компания Анкорн");
$APPLICATION->SetTitle("Реле давления");
...
<div class="container">
	...
	<div class="pb-50">
		 <? $GLOBALS['arrFilterProduct'] = array("SECTION_ID" => 59); ?> <?$APPLICATION->IncludeComponent(
	"bitrix:news.list",
	"product-list",
	Array(
