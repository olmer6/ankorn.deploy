...
$APPLICATION->SetPageProperty("keywords", "купить дифференциальные датчики давления, подбор дифференциальных датчиков давления, цены на дифференциальные датчики давления, выбор дифференциального датчика давления");
$APPLICATION->SetPageProperty("description", "Дифференциальные датчики давления - купить у официального представителя с доставкой по всем регионам России. Подробное описание продукции, характеристики, цены от производителя. Гарантия качества");
$APPLICATION->SetPageProperty("title", "Дифференциальные датчики давления - каталог, цены | Компания Анкорн");
$APPLICATION->SetTitle("Дифференциальные датчики давления");
...
<div class="container">
	<div class="page-title">
		<h1>Дифференциальные датчики давления</h1>
	</div>
	<div class="pb-50">
		 <? $GLOBALS['arrFilterProduct'] = array("SECTION_ID" => 58); ?> <?$APPLICATION->IncludeComponent(
	"bitrix:news.list",
	"product-list",
	Array(
