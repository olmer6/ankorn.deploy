...
$APPLICATION->SetPageProperty("description", "Уровнемеры EchoTREK - купить у официального представителя с доставкой по всем регионам России. Подробное описание продукции, характеристики, цены от производителя. Гарантия качества");
$APPLICATION->SetPageProperty("title", "Уровнемеры EchoTREK | Компания Анкорн");
$APPLICATION->SetTitle("Уровнемеры EchoTREK");
?>
    ...
    <section class="p-50">
        <div class="container">
            <div class="page-title">
                <h1>Уровнемеры EchoTREK</h1>
            </div>
            <div class="pb-50">
                <? $GLOBALS['arrFilterProduct'] = array("SECTION_ID" => 35); ?>
                <?$APPLICATION->IncludeComponent(
                    "bitrix:news.list",
                    "product-list",
                    Array(
