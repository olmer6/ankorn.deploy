...
$APPLICATION->SetPageProperty("description", "Уровнемеры для сыпучих материалов - купить у официального представителя с доставкой по всем регионам России. Подробное описание продукции, характеристики, цены от производителя. Гарантия качества");
$APPLICATION->SetPageProperty("title", "Уровнемеры для сыпучих материалов - датчики измерения уровня, цены | Компания Анкорн");
$APPLICATION->SetTitle("Уровнемеры для сыпучих материалов");
?>
    ...
    <section class="p-50">
        <div class="container">
            <div class="page-title">
                <h1>Уровнемеры для сыпучих материалов</h1>
            </div>
            <div class="pb-50">
                <? $GLOBALS['arrFilterProduct'] = array("SECTION_ID" => 21); ?>
                <?$APPLICATION->IncludeComponent(
                    "bitrix:news.list",
                    "product-list",
                    Array(
