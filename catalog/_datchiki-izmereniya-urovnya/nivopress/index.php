...
$APPLICATION->SetPageProperty("description", "Уровнемеры NIVOPRESS - купить у официального представителя с доставкой по всем регионам России. Подробное описание продукции, характеристики, цены от производителя. Гарантия качества");
$APPLICATION->SetPageProperty("title", "NIVOPRESS - датчики измерения уровня | Компания Анкорн");
$APPLICATION->SetTitle("Уровнемеры NIVOPRESS");
?>
    ...
    <section class="p-50">
        <div class="container">
            <div class="page-title">
                <h1>Уровнемеры NIVOPRESS</h1>
            </div>
            <div class="pb-50">
                <? $GLOBALS['arrFilterProduct'] = array("SECTION_ID" => 31); ?>
                <?$APPLICATION->IncludeComponent(
                    "bitrix:news.list",
                    "product-list",
                    Array(
