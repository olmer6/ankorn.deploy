...
$APPLICATION->SetPageProperty("description", "Большой выбор разнообразных уровнемеров производства НИВЕЛКО от компании Анкорн. Высокое качество. Звоните 8 800 333-43-14");
$APPLICATION->SetPageProperty("title", "Уровнемеры NIVELCO - купить в компании Анкорн");
$APPLICATION->SetTitle("Уровнемеры");
?>
    ...
    <section class="p-50">
        <div class="container">
            ...
            <div class="pb-50">
                <? $GLOBALS['arrFilterProduct'] = array("SECTION_ID" => 6); ?>
                <?$APPLICATION->IncludeComponent(
                    "bitrix:news.list",
                    "product-list",
                    Array(
