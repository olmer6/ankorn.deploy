...
$APPLICATION->SetPageProperty("description", "Ультразвуковые уровнемеры - купить у официального представителя с доставкой по всем регионам России. Подробное описание продукции, характеристики, цены от производителя. Гарантия качества");
$APPLICATION->SetPageProperty("title", "Ультразвуковые уровнемеры - каталог, цены | Компания Анкорн");
$APPLICATION->SetTitle("Ультразвуковые уровнемеры");
?>
    ...
    <section class="p-50">
        <div class="container">
            <div class="page-title">
                <h1>Ультразвуковые уровнемеры</h1>
            </div>
            <div class="pb-50">
                <? $GLOBALS['arrFilterProduct'] = array("SECTION_ID" => 24); ?>
                <?$APPLICATION->IncludeComponent(
                    "bitrix:news.list",
                    "product-list",
                    Array(
