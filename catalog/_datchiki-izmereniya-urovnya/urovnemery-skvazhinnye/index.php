...
$APPLICATION->SetPageProperty("description", "Скважинные уровнемеры от официального представителя с доставкой по всем регионам России. 📲 8 800 333-43-14. ✅ Электронные уровнемеры. ✅ Гарантия качества. ✅ Диапазон до 200 м. ✅ Цены от производителя.");
$APPLICATION->SetPageProperty("title", "Скважинный уровнемер в Москве, сертифицированные электронные уровнемеры для скважин по цене от 31 955 рублей");
$APPLICATION->SetTitle("Скважинные уровнемеры");
?>
    ...
    <section class="p-50">
        <div class="container">
            <div class="page-title">
                <h1>Скважинные уровнемеры</h1>
            </div>
            <div class="pb-50">
                <? $GLOBALS['arrFilterProduct'] = array("SECTION_ID" => 29); ?>
                <?$APPLICATION->IncludeComponent(
                    "bitrix:news.list",
                    "product-list",
                    Array(
