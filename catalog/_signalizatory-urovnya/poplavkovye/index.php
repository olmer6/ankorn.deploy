...
$APPLICATION->SetPageProperty("keywords", "купить поплавковый сигнализатор уровня, цена поплавковых сигнализаторов уровня, выбрать поплавковый сигнализатор уровня, подбор поплавковых сигнализаторов уровня");
$APPLICATION->SetPageProperty("description", "Поплавковые сигнализаторы уровня - купить у официального представителя с доставкой по всем регионам России. Подробное описание продукции, характеристики, цены от производителя. Гарантия качества");
$APPLICATION->SetPageProperty("title", "Поплавковые сигнализаторы уровня - каталог, цены | Компания Анкорн");
$APPLICATION->SetTitle("Поплавковые сигнализаторы уровня");
?>
    ...
    <section class="p-50">
        <div class="container">
            <div class="page-title">
                <h1>Поплавковые сигнализаторы уровня</h1>
            </div>
            <div class="pb-50">
                <? $GLOBALS['arrFilterProduct'] = array("SECTION_ID" => 38); ?>
                <?$APPLICATION->IncludeComponent(
                    "bitrix:news.list",
                    "product-list",
                    Array(
