...
$APPLICATION->SetPageProperty("description", "Сигнализаторы уровня - купить у официального представителя с доставкой по всем регионам России. Подробное описание продукции, характеристики, цены от производителя. Гарантия качества");
$APPLICATION->SetPageProperty("title", "Сигнализаторы уровня - подбор, цены | Компания Анкорн");
$APPLICATION->SetTitle("Сигнализаторы уровня");
?>
<?$GLOBALS['arrFilter']=array("SECTION_ID" => 19);?>
    <section class="p-50">
        <div class="container">
            <div class="page-title">
                <h1>Сигнализаторы уровня</h1>
            </div>
            <div class="pb-50">
                <? $GLOBALS['arrFilterProduct'] = array("SECTION_ID" => 34); ?>
