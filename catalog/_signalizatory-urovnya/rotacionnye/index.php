...
$APPLICATION->SetPageProperty("keywords", "купить ротационные сигнализаторы уровня, цена ротационных сигнализаторов уровня, выбрать ротационный сигнализатор уровня, подбор ротационных сигнализаторов уровня");
$APPLICATION->SetPageProperty("description", "Ротационные сигнализаторы уровня - купить у официального представителя с доставкой по всем регионам России. Подробное описание продукции, характеристики, цены от производителя. Гарантия качества");
$APPLICATION->SetPageProperty("title", "Ротационные сигнализаторы уровня - каталог, цены | Компания Анкорн");
$APPLICATION->SetTitle("Ротационные сигнализаторы уровня");
?>
    ...
    <section class="p-50">
        <div class="container">
            <div class="page-title">
                <h1>Ротационные сигнализаторы уровня</h1>
            </div>
            <div class="pb-50">
                <? $GLOBALS['arrFilterProduct'] = array("SECTION_ID" => 43); ?>
                <?$APPLICATION->IncludeComponent(
                    "bitrix:news.list",
                    "product-list",
                    Array(
