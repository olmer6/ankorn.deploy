...
$APPLICATION->SetPageProperty("keywords", "купить емкостные сигнализаторы уровня, цена емкостных сигнализаторов уровня, выбрать емкостной сигнализатор уровня, подбор емкостных сигнализаторов уровня");
$APPLICATION->SetPageProperty("description", "Емкостные сигнализаторы уровня - купить у официального представителя с доставкой по всем регионам России. Подробное описание продукции, характеристики, цены от производителя. Гарантия качества");
$APPLICATION->SetPageProperty("title", "Емкостные сигнализаторы уровня - каталог, цены | Компания Анкорн");
$APPLICATION->SetTitle("Емкостные сигнализаторы уровня");
?>
    ...
    <section class="p-50">
        <div class="container">
            <div class="page-title">
                <h1>Емкостные сигнализаторы уровня</h1>
            </div>
            <div class="pb-50">
                <? $GLOBALS['arrFilterProduct'] = array("SECTION_ID" => 42); ?>
                <?$APPLICATION->IncludeComponent(
                    "bitrix:news.list",
                    "product-list",
                    Array(
