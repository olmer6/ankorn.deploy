...
$APPLICATION->SetPageProperty("description", "Сигнализаторы уровня NIVOSWITCH - купить у официального представителя с доставкой по всем регионам России. Подробное описание продукции, характеристики, цены от производителя. Гарантия качества");
$APPLICATION->SetPageProperty("title", "Сигнализаторы NIVOSWITCH | Компания Анкорн");
$APPLICATION->SetTitle("Сигнализаторы NIVOSWITCH");
?>
    ...
    <section class="p-50">
        <div class="container">
            <div class="page-title">
                <h1>Сигнализаторы NIVOSWITCH</h1>
            </div>
            <div class="pb-50">
                <? $GLOBALS['arrFilterProduct'] = array("SECTION_ID" => 45); ?>
                <?$APPLICATION->IncludeComponent(
                    "bitrix:news.list",
                    "product-list",
                    Array(
