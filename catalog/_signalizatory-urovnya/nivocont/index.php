...
$APPLICATION->SetPageProperty("description", "Купить сигнализатор уровня NIVOCONT с 5-летней гарантией от производителя в России у компании Анкорн, которая с 2013 года присутствует на рынке КИПиА. Оставить заявку можно по телефону прямо сейчас: 8 800 333-43-14");
$APPLICATION->SetPageProperty("description", "Купить сигнализатор уровня NIVOCONT с 5-летней гарантией от производителя в России у компании Анкорн, которая с 2013 года присутствует на рынке КИПиА. Оставить заявку можно по телефону прямо сейчас: 8 800 333-43-14");
$APPLICATION->SetPageProperty("title", "Сигнализаторы NIVOCONT | Компания Анкорн");
$APPLICATION->SetTitle("Сигнализаторы NIVOCONT");
?>
    ...
    <section class="p-50">
        <div class="container">
            <div class="page-title">
                <h1>Сигнализаторы NIVOCONT</h1>
            </div>
            <div class="pb-50">
                <? $GLOBALS['arrFilterProduct'] = array("SECTION_ID" => 44); ?>
                <?$APPLICATION->IncludeComponent(
                    "bitrix:news.list",
                    "product-list",
                    Array(
