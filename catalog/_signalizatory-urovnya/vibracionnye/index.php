...
$APPLICATION->SetPageProperty("keywords", "купить вибрационный сигнализатор уровня, цена вибрационных сигнализаторов уровня, выбрать вибрационный сигнализатор уровня, подбор вибрационных сигнализаторов уровня");
$APPLICATION->SetPageProperty("description", "Вибрационные сигнализаторы уровня - купить у официального представителя с доставкой по всем регионам России. Подробное описание продукции, характеристики, цены от производителя. Гарантия качества");
$APPLICATION->SetPageProperty("title", "Вибрационные сигнализаторы уровня - каталог, цены | Компания Анкорн");
$APPLICATION->SetTitle("Вибрационные сигнализаторы уровня");
?>
    ...
    <section class="p-50">
        <div class="container">
            <div class="page-title">
                <h1>Вибрационные сигнализаторы уровня</h1>
            </div>
            <div class="pb-50">
                <? $GLOBALS['arrFilterProduct'] = array("SECTION_ID" => 41); ?>
                <?$APPLICATION->IncludeComponent(
                    "bitrix:news.list",
                    "product-list",
                    Array(
